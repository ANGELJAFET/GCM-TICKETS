  ...
  const tabBtn = (v: InvView, icon: React.ReactNode, label: string, badge?: number) => (
    <button
      ...
      className={clsx(
        ...
        view === v ? 'border-blue-300/50 bg-admin-blue-light text-admin-blue' : 'text-admin-text-sec hover:border-blue-200 hover:bg-admin-blue-light hover:text-admin-blue'
      )}
    >
      {icon} {label}
